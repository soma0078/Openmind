    ...
    <>
      <div className='flex flex-col gap-3'>
        <div className='flex gap-3 mb-2'>
          ...
          <button var="icon" className='flex justify-center items-center w-10 h-10 rounded-[200px] bg-[#FEE500]'>
            <img className='w-5 h-5' src={kakaoImage} alt="카카오톡으로 공유" />
          </button>
          <button var="icon" className='flex justify-center items-center w-10 h-10 rounded-[200px] bg-[#1877F2]'>
