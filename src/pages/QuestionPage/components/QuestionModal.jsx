  ...
  return (
    <>
      ...
      {isModalOpen && (
        <dialog
          ref={dialogRef}
          className='absolute shadow-xl rounded-3xl p-9 max-md:p-6 top-1 bottom-1 ring-1 left-1'
          open={true}
        >
          ...
          <form onSubmit={handleSubmit}>
            ...
            >
              To.
              <img src={userData.imageSource} alt={userData.imageSource} className='rounded-full w-7 h-7' />
              {userData.name}
            </label>
            <textarea
              id={textareaId}
            ...
            <button
              ...
              className={`w-full rounded-md bg-amber-950 text-white px-6 py-3 block ${
                !questionContent.trim() && 'opacity-30'
              }`}
            >
              질문 보내기
            </button>
